...
<template>
  <section v-bind="FLAG_PARADE.elAttrs" class="h-screen relative">
    <div
    ...
    >
      ...
      <h3 class="text-2xl xl:text-4xl text-white mt-8">
        3 PM, Brno City Centre
      </h3>
    </div>
...
section {
  ...
  url("~/assets/img/flag-parade.jpg");
}
</style>
